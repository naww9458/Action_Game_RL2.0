...
class Trainer(Trainer_base):
    def __init__(
        ...
        if is_training and not checkpoint_path:
            ...
            cfg["experiment"]["directory"] = str(run_parent)
            cfg["experiment"]["experiment_name"] = make_experiment_name(
                meta.env_id, meta.algorithm, framework=meta.framework,
    ...
    def _load_mjlab_actor(self, checkpoint_path, policy_model) -> bool:
        ...
        from rl_framework.skrl_script.policy_PPO_g1_velocity import load_mjlab_checkpoint
