...
expects runs under ``runs/RSL-rl/`` with checkpoints mirrored into
``<run>/checkpoints/``. This subclass mirrors every saved checkpoint there so
RSL-rl runs integrate with the existing launcher tooling.
"""
