...
from script.environments.rewards.game_end_reward import ShootingGameTerminated
from script.environments.rewards.player_reward import PlayerShotReward2, PlayerFaceToTargetReward1, PlayerFaceToTargetReward2
from script.environments.rewards.player_reward_diff import PlayerFaceToTargetReward1_diff, BulletTrajectoryEvasionReward_diff, ProximityPenaltyReward_diff
...
class DodgeDuel(StandingTarget):
    """
    DodgeDuel: Basic setup with a dynamic body and a static kinematic body.
    ...
    def setup(self):
        ...
        try:
            ...
            GameConfig.reward_parameters = get_default_train_cfg("dodge_duel").reward_parameters
