...
def _bind_g1_environment_resources(reward, environment) -> None:
    ...
    reward.prev_actions = getattr(environment, "prev_actions", None)
    reward.rl_action_dim = getattr(environment, "rl_action_dim", GameConfig.ACTION_SHAPE_OFFSET)
    reward.num_env = getattr(environment, "num_env", GameConfig.NUM_PLAYERS)
